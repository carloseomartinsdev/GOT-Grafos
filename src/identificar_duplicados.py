...
if response.status_code == 200:
    ...
    try:
        ...
        try:
            ...
            print(f"\n[ERRO] JSON inválido: {je}")
            print(f"\nTentando usar dicionário manual...")
        ...
        print(f"\nVerifique o arquivo 'resposta_deepseek.txt' para debug")
        print("\nAlternativa: Execute 'python criar_dicionario_manual.py'")
        input("\nPressione Enter para sair...")
        exit()
